...
- 🚨 ABSOLUTE MANDATE: You MUST respond ONLY in the user's preferred language, regardless of what language the user writes their message in
- 🚨 CRITICAL RULE: The user's language preference overrides the language of their input message
- 🚨 NON-NEGOTIABLE: If user preference is "spanish", respond ENTIRELY in Spanish - even if user writes in English, French, Arabic, etc.
- 🚨 NON-NEGOTIABLE: If user preference is "french", respond ENTIRELY in French - even if user writes in English, Spanish, Arabic, etc.
- 🚨 NON-NEGOTIABLE: If user preference is "arabic", respond ENTIRELY in Arabic - even if user writes in English, Spanish, French, etc.
- 🚨 NON-NEGOTIABLE: If user preference is any other language, respond ENTIRELY in that language - regardless of input language
- 🚨 NON-NEGOTIABLE: If user preference is "english", respond in English - even if user writes in other languages
- 🚨 UNDERSTANDING vs RESPONSE: You can understand messages in any language, but you MUST respond only in the user's preferred language
...
- 🚨 FINAL WARNING: Ignoring the user's language preference is a critical error - always check the user profile and respond accordingly
...
- 🚨 ABSOLUTE MANDATE: You MUST respond ONLY in the user's preferred language: ${userProfile?.language || 'english'}
- 🚨 CRITICAL RULE: The user's language preference (${userProfile?.language || 'english'}) overrides the language of their input message
- 🚨 NON-NEGOTIABLE: If language is "spanish", respond ENTIRELY in Spanish - even if user writes in English, French, Arabic, etc.
- 🚨 NON-NEGOTIABLE: If language is "french", respond ENTIRELY in French - even if user writes in English, Spanish, Arabic, etc.
- 🚨 NON-NEGOTIABLE: If language is "german", respond ENTIRELY in German - even if user writes in English, Spanish, French, etc.
- 🚨 NON-NEGOTIABLE: If language is "arabic", respond ENTIRELY in Arabic - even if user writes in English, Spanish, French, etc.
- 🚨 UNDERSTANDING vs RESPONSE: You can understand messages in any language, but you MUST respond only in ${userProfile?.language || 'english'}
...
async function buildCoverLetterPrompt(message, sessionId, userProfile, toggleState, userId) {
  ...
  return `🚨 CRITICAL LANGUAGE RULE: You MUST write this cover letter ONLY in the user's preferred language (${userProfile?.language || 'english'}), regardless of what language the user wrote their request in. The user's language preference overrides the input language.

Please create a 99% ATS-OPTIMIZED, HIRING MANAGER-TARGETED cover letter for this specific job. 
...
LANGUAGE AND COMMUNICATION REQUIREMENTS:
- 🚨 ABSOLUTE MANDATE: You MUST respond ONLY in the user's preferred language: ${userLanguage}
- 🚨 CRITICAL RULE: The user's language preference (${userLanguage}) overrides the language of their input message
- 🚨 NON-NEGOTIABLE: If language is "spanish", respond ENTIRELY in Spanish - even if user writes in English, French, Arabic, etc.
- 🚨 NON-NEGOTIABLE: If language is "french", respond ENTIRELY in French - even if user writes in English, Spanish, Arabic, etc.
- 🚨 NON-NEGOTIABLE: If language is "german", respond ENTIRELY in German - even if user writes in English, Spanish, French, etc.
- 🚨 NON-NEGOTIABLE: If language is "arabic", respond ENTIRELY in Arabic - even if user writes in English, Spanish, French, etc.
- 🚨 UNDERSTANDING vs RESPONSE: You can understand messages in any language, but you MUST respond only in ${userLanguage}
